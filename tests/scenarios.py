...
GSB_LEAD_HAPPY_PATH_SCENARIOS = [
    {
        "test_id": "gsb_lead_ploan_base",
        "product_name": "moneydd.pLoan",
        "answers": GSB_LEAD_PLOAN_ANSWERS
    },
    {
        "test_id": "gsb_lead_nanoloan_base",
        "product_name": "moneydd.nanoLoan",
        "answers": GSB_LEAD_NANOLOAN_ANSWERS
    }
]